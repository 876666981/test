...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#bundBtn").click(function () {
			var activityId = $("input[name=xz]:checked");
			if (activityId.length == 0){
				...
				for (var i = 0;i<activityId.length;i++){
						...
						param += "&activityId="+$(activityId[i]).val();
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html += '<td>'+n.endDate+'</td>';
					html += '<td>'+n.owner+'</td>';
					html += '<td><a href="javascript:void(0);"  onclick="delBund(\''+n.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>';
					html += '</tr>';
				})
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${requestScope.c.fullname}${requestScope.c.appellation} <small>${c.company}</small></h3>
		</div>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${requestScope.c.fullname}${requestScope.c.appellation}</b></div>
