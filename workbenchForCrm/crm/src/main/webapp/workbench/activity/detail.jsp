			...
			$.ajax({
				...
				success:function (data) {
					...
					if(data.success){
						...
						html += '<h5>'+data.ar.createBy+'</h5>';
						html += '<font color="gray">市场活动1</font> <font color="gray">-</font> <b>'+data.ar.noteContent+'</b> <small style="color: gray;"> '+data.ar.createBy+' 由'+data.ar.createTime+'</small>';
						html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
						html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: darkred;"></span></a>';
						html += '&nbsp;&nbsp;&nbsp;&nbsp;';
						html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: darkred;"></span></a>';
						html += '</div>';
						html += '</div>';
						html += '</div>';
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html += '<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
					html += '<div style="position: relative; top: -40px; left: 40px;" >';
					html += '<h5>'+n.createBy+'</h5>';
					html += '<font color="gray">市场活动1</font> <font color="gray">-</font> <b>'+n.noteContent+'</b> <small style="color: gray;"> '+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: darkred;"></span></a>';
					html += '&nbsp;&nbsp;&nbsp;&nbsp;';
					html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: darkred;"></span></a>';
